...
4. Copy and paste the following into the **Repository URL** `https://github.com/kintoproj/kinto-examples/tree/main/todo-hasura`.
...
2. Click on the **Web App** service.
3. Click on the **Import URL** tab.
4. Copy and paste the following into the **Repository URL** `https://github.com/kintoproj/kinto-examples/tree/main/todo-react`.
5. Click on the **Connect** button.
6. Type `Dockerfile` in the **Dockerfile Name** field.
